...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 37, 2, 825);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 36, 1, 799);
			attr_dev(div1, "class", "section header");
			add_location(div1, file, 35, 0, 769);
		},
...
async function preload() {
	try {
		...
		return this.error(500, "There was an eror in calling the api, please try again in 5 minutes");
	}
}

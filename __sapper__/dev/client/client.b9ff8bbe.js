...
const components = [
	{
		js: () => Promise.all([import('./index.88024470.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.6db147be.js'), ]).then(function(x) { return x[0]; })
	}
];

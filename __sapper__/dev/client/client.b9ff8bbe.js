...
const components = [
	{
		js: () => Promise.all([import('./index.88024470.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.6db147be.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	}
];

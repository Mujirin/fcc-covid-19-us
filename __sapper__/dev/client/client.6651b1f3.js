...
const components = [
	{
		js: () => Promise.all([import('./index.51abb8c3.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.8aa29c90.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].3fa2dc7c.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	}
];

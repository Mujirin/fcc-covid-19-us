import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, b as space, j as claim_element, k as children, l as claim_text, f as detach_dev, h as claim_space, o as attr_dev, n as add_location, p as insert_dev, r as append_dev, B as set_data_dev, C as noop, c as create_component, m as claim_component, u as mount_component, y as transition_in, z as transition_out, A as destroy_component } from './client.6021ae90.js';
...
function parseChart(historicData, key, label, color) {
    const chartData = historicData.map(data => {
        return {
            x: devalue(moment(data.date, 'YYYYMMDD')),
            // x; 'x',
            y: data[key]
        }
    });

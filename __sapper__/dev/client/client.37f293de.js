...
const components = [
	{
		js: () => Promise.all([import('./index.d051cf1e.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.239077dc.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].a0224af6.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	}
];

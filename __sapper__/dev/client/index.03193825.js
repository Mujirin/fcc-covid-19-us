...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 35, 2, 723);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 34, 1, 697);
			attr_dev(div1, "class", "section header");
			add_location(div1, file, 33, 0, 667);
		},

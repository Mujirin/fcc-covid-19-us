...
const components = [
	{
		js: () => Promise.all([import('./index.e3c27849.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.ea7ff4d6.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].56fca847.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	}
];

...
const components = [
	{
		js: () => Promise.all([import('./index.7d026ac7.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.3e7fa5d3.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].e1d4744d.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	}
];

...
const components = [
	{
		js: () => Promise.all([import('./index.558b8bb6.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.3805f2b7.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].534c8f3f.js'), __inject_styles(["client-06494acf.css"])]).then(function(x) { return x[0]; })
	}
];

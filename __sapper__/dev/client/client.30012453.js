...
const components = [
	{
		js: () => Promise.all([import('./index.c2a57f5e.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.62adc42d.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[state].ed031982.js'), __inject_styles(["client-316a7a0d.css"])]).then(function(x) { return x[0]; })
	}
];
